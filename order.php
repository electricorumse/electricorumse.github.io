        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, vă mulțumim pentru comanda dvs.!
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">Mulțumesc, informații salvate.</h3>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        Sunteți pe calea cea dreaptă!
                        <br>
                        Coletul dvs. este deja pe drum. Asigurați-vă că numărul dvs. de telefon a fost introdus corect și răspundeți la apelul managerului nostru pentru a confirma detaliile.
                    </p>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text">Vă rugăm să verificați informațiile de contact:</h3>
                <div class="list-info">
                ...
                <p class="success-page__message_fail">
                    <a class="success-page__message_fail__link" href="javascript:history.back()">
                        Dacă ați greșit, mergeți înapoi și completați din nou formularul.
                    </a>
                </p>
                <h3 class="success-page__text" id="lowerH">
                    Pentru a accelera plasarea comenzii, completați adresa dvs. de livrare:
                </h3>
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            <label for="" class="success-page__form__label">Adresă</label>
                            <input class="success-page__form__input" name="address"
                                placeholder="USA, New York, Liberty Avenue 23" type="text" />
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> Trimiteți </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>E-mail și/sau adresa necesară!</span>" +
        "<br><br>Va rugam verificati corectitudinea datelor de contact introduse.",
